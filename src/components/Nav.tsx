    ...
    >
      <div className="max-w-6xl mx-auto px-4 h-full flex items-center justify-between">
        ...
        <a href="#" className="flex items-center gap-1 group">
          <span className="font-sans font-bold text-2xl tracking-tight" style={{ color: 'var(--color-text)' }}>
            JD
          </span>
          <span
          ...
          />
          <span className="font-sans font-medium text-sm ml-1 hidden sm:inline" style={{ color: 'var(--color-muted)' }}>
            Informática
          </span>
        </a>
      ...
      <div
        id="mobile-nav"
        className="md:hidden absolute top-full left-0 right-0 z-40 overflow-hidden"
        aria-hidden={!open}
        style={{
        ...
        <div className="flex flex-col p-4 gap-1">
          {links.map((l) => (
            <a
              ...
              className="font-sans text-sm font-medium py-3 px-2"
              style={{ color: 'var(--color-text)', minHeight: '44px', display: 'flex', alignItems: 'center' }}
            >
              {l.label}
            </a>
          ))}
          <a
            ...
            style={{ backgroundColor: 'var(--color-accent)', color: 'var(--color-bg)', minHeight: '44px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
            aria-label="Contactar por WhatsApp"
          >
            Escribinos por WhatsApp
          </a>
